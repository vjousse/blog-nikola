...
BLOG_AUTHOR = "Vincent Jousse"  # (translatable)
BLOG_TITLE = "Vince's"  # (translatable)
...
CODE_COLOR_SCHEME = 'solarizeddark'
...
INDEX_READ_MORE_LINK = ' <a class="more-link" href="{link}">{read_more}…</a>'
...
TWITTER_CARD = {
    ...
    'site': '@vjousse',         # twitter nick for the website
    'creator': '@vjousse',      # Username for the content creator / author.
}
